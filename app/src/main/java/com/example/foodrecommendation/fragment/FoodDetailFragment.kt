...
class FoodDetailFragment : Fragment() {
    ...
    val ingredientsList = mutableListOf<String>("400g Tomatoes","40g Onion","40g Bell pepper",
        "20g Unsalted butter","10g Garlic","150g Beef","1/2Tsp Salt","2Tsp Sugar","50g Ketchup",
        "1Tsp Dried Oregano","Black pepper","10g Parsley")
    ...
    override fun onStart() {
        super.onStart()
        tvIngredient.text = displayItems(ingredientsList)
        tvCookSteps.text = displayItems(list)
        var count = 0
        tvFoodImage.setOnClickListener {
            count = (count + 1) % 3
            tvFoodImage.setImageResource(getResourceId("spaghetti",count,requireContext()))
        }
    }
}
...
fun getResourceId(filename: String, count: Int, context: Context): Int{
    val id: Int = context.resources.getIdentifier(filename+"_"+count.toString(),"drawable",context.packageName)
    return id
}
